...
* [GraalVM Native Image Support](https://docs.spring.io/spring-boot/3.5.0-SNAPSHOT/reference/packaging/native-image/introducing-graalvm-native-images.html)
...
* [Configure AOT settings in Build Plugin](https://docs.spring.io/spring-boot/3.5.0-SNAPSHOT/how-to/aot.html)
